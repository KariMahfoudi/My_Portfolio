# Astro Developer Portal — Listing Copy

Paste these into portal.astro.build → your "Darkness" theme → Edit.
...
Astro · Three.js · TypeScript · MDX · Blog · Portfolio · Dark Mode · Responsive

## Links

- Repository: https://github.com/kpab/astro-darkness
...
1. docs/portal/01-home.webp — Hero with the Three.js particle background (use as the main/preview image)
2. docs/portal/02-blog.webp — Blog index
3. docs/portal/03-projects.webp — Project portfolio with featured cards
4. docs/portal/05-blog-post.webp — Blog post layout
5. docs/portal/04-about.webp — About page

All images are 1600×900 (16:9) WebP, the recommended portal format.
